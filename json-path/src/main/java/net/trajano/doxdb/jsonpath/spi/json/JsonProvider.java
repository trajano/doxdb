 ...
 */
package net.trajano.doxdb.jsonpath.spi.json;

import java.io.InputStream;
import java.util.Collection;

import net.trajano.doxdb.jsonpath.InvalidJsonException;
...
public interface JsonProvider {
     ...
     * @return the map entry or {@link net.trajano.doxdb.jsonpath.spi.json.JsonProvider#UNDEFINED} for missing properties
     */
